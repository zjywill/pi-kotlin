...
function-valued `user_bash` output/exit status. Command-time tool, command, and
flag registrations are compared after the host refreshes its live registration
...
stream routing, bash cancellation, immediate active-tool refresh, and invalid
